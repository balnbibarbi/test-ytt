...
dump = struct.make(dump=dump_many, dump_attrs=dump_attrs_many, getattrs=getattrs, merge=merge, extend=_extend, _=_, to_primitive=to_primitive, curry=curry, compose=_compose_all, object=object)
